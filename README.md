...
![데스크톱 화면](images/%EC%9B%B9%ED%99%94%EB%A9%B4.png)
...
같은 페이지가 모바일에서는 1열로 재배치되고, 상단 메뉴는 햄버거 버튼으로 바뀝니다.

<img src="images/%EB%AA%A8%EB%B0%94%EC%9D%BC%ED%99%94%EB%A9%B4.png" alt="모바일 화면" width="320">

### 다크 모드

우측 상단 버튼으로 전환하며, 선택한 테마는 브라우저에 기억됩니다.
처음 방문 시에는 운영체제 설정을 따릅니다.

![다크 모드 화면](images/%EB%8B%A4%ED%81%AC%EB%AA%A8%EB%93%9C.png)
...
왼쪽에 입력한 내용으로 오른쪽 타임테이블이 생성됩니다.
블록마다 **시작·종료 시각 / 집중·회복 구분 / 완료 기준 / 요령**이 함께 표시됩니다.

![AI 기능 동작 화면](images/ai%EA%B8%B0%EB%8A%A5%EB%8F%99%EC%9E%91%ED%99%94%EB%A9%B4.png)
